        ...
        <div className={styles.cards}>
          <div className={styles.card}>
            ...
            <div className={styles.textos}>
              ...
              <p className={styles.texto}>Ao ver o anúncio da nova turma de formação básica da Pretalab,  
              vi uma oportunidade única para ingressar nessa jornada. Decidi não apenas compartilhar essa 
              oportunidade com minha irmã, mas também me comprometer em participar ativamente do curso. Além de fortalecer nosso vínculo 
              familiar, vejo esse compromisso como uma chance de ampliar meu próprio conhecimento e habilidades. 
              Acredito que essa experiência abrirá novas perspectivas e oportunidades para mim, fortalecendo meu trajeto na área de tecnologia.</p>
            </div>
          </div>
          <div className={styles.card}>
