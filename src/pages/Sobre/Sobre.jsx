import Foto_perfil_Tatiane_Neris from '../../assets/Foto_perfil_Tatiane_Neris.png';
  ...
  return (
    <>
      <div className={styles.header}>
        <div>
            <img className={styles.headerImg} src={Foto_perfil_Tatiane_Neris} alt="Foto de Perfil" />
        </div>
      </div>

      <div className={styles.containerSobre} >
          <h1 className={styles.nomeCompleto}>Tatiane Neris</h1>
          <h2 className={styles.profissao}>Estudante de ADS</h2>
          <p className={styles.sobreMim}>
              ...
              <br />
               Essa foi a área onde eu mais me identifiquei,
